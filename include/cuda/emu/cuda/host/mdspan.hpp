...
namespace emu::cuda::host
{
    ...
    struct mdspan : emu::detail::basic_mdspan<
        T, Extents, LayoutPolicy, AccessorPolicy, cuda::host_location_policy,
        mdspan<T, Extents, LayoutPolicy, AccessorPolicy>
    >
    {
        using base = emu::detail::basic_mdspan< T, Extents, LayoutPolicy, AccessorPolicy, cuda::host_location_policy, mdspan >;
