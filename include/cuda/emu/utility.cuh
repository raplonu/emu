...
namespace emu
{
     ...
     */
    EMU_DEVICE inline std::size_t item_per_block_nb(std::size_t item_nb) { return item_per_group_nb(item_nb, EMU_SIZE_G); }
     ...
     * @return std::size_t item_per_block_nb
     */
    EMU_DEVICE inline std::size_t item_per_block_local_nb(std::size_t item_nb) { return item_per_group_local_nb(item_nb, EMU_BID, EMU_SIZE_G); }
     ...
     */
    EMU_DEVICE inline std::size_t thread_item_pos_custom(std::size_t custom_item_per_block_nb) { return EMU_TID + EMU_BID * custom_item_per_block_nb; }
     ...
     */
    EMU_DEVICE inline std::size_t thread_item_pos(std::size_t item_nb) { return thread_item_pos_custom(item_per_block_nb(item_nb)); }
     ...
     */
    EMU_DEVICE inline bool is_active(std::size_t item_nb, std::size_t item_per_block_nb) {
     ...
     * @return bool is_active
     */
    EMU_DEVICE inline bool is_active(std::size_t item_nb) {
