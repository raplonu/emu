...
namespace cusolver
{
    ...
    template void getrs<double>(const handle_t & handle, cublas::Operation uplo,int n, int nrhs, const double *A, int lda, const int *devIpiv, double *B, int ldb, int *devInfo);
    template void getrs<cuComplex>(const handle_t & handle, cublas::Operation uplo,int n, int nrhs, const cuComplex *A, int lda, const int *devIpiv, cuComplex *B, int ldb, int *devInfo);
    template void getrs<cuDoubleComplex>(const handle_t & handle, cublas::Operation uplo,int n, int nrhs, const cuDoubleComplex *A, int lda, const int *devIpiv, cuDoubleComplex *B, int ldb, int *devInfo);
